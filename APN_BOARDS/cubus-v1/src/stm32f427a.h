...
#ifndef __BOARDS_ARM_STM32_STM32F427A_SRC_STM32F427A_H
#define __BOARDS_ARM_STM32_STM32F427A_SRC_STM32F427A_H
...
#define GPIO_KILL_SW_EN			(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTG|GPIO_PIN7)
/* KILL Switch 1 GPIOs */
...
#define GPIO_KILL_SW1_POS		(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTD|GPIO_PIN15)

/* KILL Switch 2 GPOIs */  //(GPIO_MODE|GPIO_PULL_DEF|GPIO_SPEED|GPIO_OUTPUT|GPIO_PORT|GPIO_PIN|)
#define GPIO_KILL_SW2_STAT		(GPIO_INPUT|GPIO_FLOAT|GPIO_PORTG|GPIO_PIN5)
#define GPIO_KILL_SW2_NEG		(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTG|GPIO_PIN2)
#define GPIO_KILL_SW2_POS		(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTG|GPIO_PIN4)
...
#define GPIO_MSN_3V3_EN			(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTH|GPIO_PIN3)
#define GPIO_COM_4V_EN			(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTA|GPIO_PIN1)
#define GPIO_MSN_5V_EN			(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTB|GPIO_PIN12)
#define GPIO_BURNER_EN			(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTH|GPIO_PIN12)
#define GPIO_UNREG_EN			(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTH|GPIO_PIN5)

#define COM_RSSI                //
#define COM_CWKEY               //  PE15
#define COM_ON_OFF              //  PE13
#define COM_CONFIG              //  PH9

/* MSN Enable GPIOs */
#define GPIO_GPIO1  			(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTE|GPIO_PIN11)		//GPIO_1 On Board
#define GPIO_GPIO2		    	(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTA|GPIO_PIN8)		//GPIO_2 On Board
#define GPIO_GPIO3  			(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTF|GPIO_PIN10)	//GPIO_3 On Board
...
#define GPIO_MUX_EN			    (GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTI|GPIO_PIN0)
...
#define GPIO_LIS3MDL_INT		(GPIO_INPUT|GPIO_FLOAT|GPIO_PORTD|GPIO_PIN10)
#define GPIO_LIS3MDL_CS			(GPIO_OUTPUT|GPIO_PULLUP|GPIO_SPEED_2MHz|GPIO_OUTPUT_SET|GPIO_PORTD|GPIO_PIN9)
#define GPIO_LIS3MDL_DRDY		(GPIO_INPUT|GPIO_PULLUP|GPIO_PORTD|GPIO_PIN8)
#define GPIO_MPU_INT			(GPIO_INPUT|GPIO_FLOAT|GPIO_PORTD|GPIO_PIN13)
#define GPIO_MPU_CS			    (GPIO_OUTPUT|GPIO_PULLUP|GPIO_SPEED_2MHz|GPIO_OUTPUT_SET|GPIO_PORTH|GPIO_PIN10)

#define GPIO_EXT_ADC1_CS		(GPIO_OUTPUT|GPIO_PULLUP|GPIO_SPEED_2MHz|GPIO_OUTPUT_SET|GPIO_PORTH|GPIO_PIN4)

#define EXT_ADC_CHANNEL_COUNT 12
...
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_ARM_STM32_STM32F427A_SRC_STM32F427A_H */
