...
#define GPIO_MSN_3V3_EN (GPIO_OUTPUT | GPIO_FLOAT | GPIO_SPEED_2MHz | GPIO_OUTPUT_CLEAR | GPIO_PORTH | GPIO_PIN14) ///
...
/* MSN Enable GPIOs */
#define GPIO_MSN1_EN (GPIO_OUTPUT | GPIO_FLOAT | GPIO_SPEED_2MHz | GPIO_OUTPUT_CLEAR | GPIO_PORTE | GPIO_PIN11) // GPIO_1 On Board
...
#define GPIO_SFM_MODE (GPIO_OUTPUT | GPIO_FLOAT | GPIO_SPEED_2MHz | GPIO_OUTPUT_SET | GPIO_PORTB | GPIO_PIN1)
