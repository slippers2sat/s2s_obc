...
CONFIG_BASE_DEFCONFIG="../APN_BOARDS/cubus_em/configs/nsh-dirty"
CONFIG_BUILD_FLAT=y
...
# CONFIG_DEBUG_ASSERTIONS_EXPRESSION is not set
...
# CONFIG_DEBUG_SENSORS is not set
CONFIG_DEBUG_SPI=y
...
# CONFIG_ARCH_TRICORE is not set
CONFIG_ARCH="arm"
...
# CONFIG_ARCH_CHIP_MX8MP is not set
# CONFIG_ARCH_CHIP_CXD56XX is not set
# CONFIG_ARCH_CHIP_PHY62XX is not set
# CONFIG_ARCH_CHIP_TLSR82 is not set
# CONFIG_ARCH_CHIP_MPS is not set
# CONFIG_ARCH_CHIP_QEMU_ARM is not set
# CONFIG_ARCH_CHIP_GOLDFISH_ARM is not set
# CONFIG_ARCH_CHIP_AT32 is not set
...
CONFIG_ARM_THUMB=y
# CONFIG_ARCH_HAVE_PSCI is not set
...
# CONFIG_DEBUG_BUSFAULT is not set
CONFIG_ARCH_HAVE_USAGEFAULT_DEBUG=y
# CONFIG_DEBUG_USAGEFAULT is not set
# CONFIG_ARM_SEMIHOSTING_SYSLOG is not set

#
# ARMv7-M Configuration Options
#
...
# CONFIG_ARCH_CHIP_STM32L151RE is not set
# CONFIG_ARCH_CHIP_STM32L152RE is not set
# CONFIG_ARCH_CHIP_STM32L151VE is not set
# CONFIG_ARCH_CHIP_STM32L152VE is not set
# CONFIG_ARCH_CHIP_STM32L151QE is not set
# CONFIG_ARCH_CHIP_STM32L152QE is not set
# CONFIG_ARCH_CHIP_STM32L151ZE is not set
# CONFIG_ARCH_CHIP_STM32L152ZE is not set
...
# CONFIG_ARCH_CHIP_STM32F207VC is not set
# CONFIG_ARCH_CHIP_STM32F207VE is not set
# CONFIG_ARCH_CHIP_STM32F207VF is not set
# CONFIG_ARCH_CHIP_STM32F207VG is not set
# CONFIG_ARCH_CHIP_STM32F207IC is not set
# CONFIG_ARCH_CHIP_STM32F207IE is not set
# CONFIG_ARCH_CHIP_STM32F207IF is not set
# CONFIG_ARCH_CHIP_STM32F207IG is not set
# CONFIG_ARCH_CHIP_STM32F207ZC is not set
# CONFIG_ARCH_CHIP_STM32F207ZE is not set
# CONFIG_ARCH_CHIP_STM32F207ZF is not set
# CONFIG_ARCH_CHIP_STM32F207ZG is not set
# CONFIG_ARCH_CHIP_STM32F302K6 is not set
# CONFIG_ARCH_CHIP_STM32F302K8 is not set
# CONFIG_ARCH_CHIP_STM32F302C6 is not set
# CONFIG_ARCH_CHIP_STM32F302C8 is not set
# CONFIG_ARCH_CHIP_STM32F302R6 is not set
# CONFIG_ARCH_CHIP_STM32F302R8 is not set
...
# CONFIG_ARCH_CHIP_STM32F303VD is not set
# CONFIG_ARCH_CHIP_STM32F303VE is not set
# CONFIG_ARCH_CHIP_STM32F303ZD is not set
# CONFIG_ARCH_CHIP_STM32F303ZE is not set
...
# CONFIG_ARCH_CHIP_STM32F411CE is not set
# CONFIG_ARCH_CHIP_STM32F411RE is not set
# CONFIG_ARCH_CHIP_STM32F411VE is not set
# CONFIG_ARCH_CHIP_STM32F412CE is not set
# CONFIG_ARCH_CHIP_STM32F412ZG is not set
...
# CONFIG_ARCH_CHIP_STM32G431K is not set
# CONFIG_ARCH_CHIP_STM32G431C is not set
# CONFIG_ARCH_CHIP_STM32G431R is not set
# CONFIG_ARCH_CHIP_STM32G431M is not set
# CONFIG_ARCH_CHIP_STM32G431V is not set
# CONFIG_ARCH_CHIP_STM32G474C is not set
# CONFIG_ARCH_CHIP_STM32G474M is not set
# CONFIG_ARCH_CHIP_STM32G474R is not set
# CONFIG_ARCH_CHIP_STM32G474Q is not set
# CONFIG_ARCH_CHIP_STM32G474V is not set
...
CONFIG_STM32_STM32F427A=y
# CONFIG_STM32_DFU is not set

#
# STM32 Peripheral Support
#
CONFIG_STM32_HAVE_FLASH_ICACHE=y
CONFIG_STM32_HAVE_FLASH_DCACHE=y
CONFIG_STM32_HAVE_OVERDRIVE=y
CONFIG_STM32_HAVE_CRYP=y
CONFIG_STM32_HAVE_CCM=y
CONFIG_STM32_HAVE_OTGFS=y
CONFIG_STM32_HAVE_FMC=y
CONFIG_STM32_HAVE_IOCOMPENSATION=y
...
CONFIG_STM32_HAVE_I2SPLL=y
CONFIG_STM32_HAVE_IP_DBGMCU_V2=y
CONFIG_STM32_HAVE_IP_I2C_V1=y
CONFIG_STM32_HAVE_IP_DMA_V2=y
CONFIG_STM32_HAVE_IP_TIMERS_V1=y
CONFIG_STM32_HAVE_IP_ADC_V1=y
...
# end of STM32 Peripheral Support
...
# CONFIG_STM32_SYSCFG_IOCOMPENSATION is not set
CONFIG_STM32_FLASH_ICACHE=y
CONFIG_STM32_FLASH_DCACHE=y
...
# CONFIG_STM32_I2SPLL is not set
# CONFIG_STM32_CCMEXCLUDE is not set
CONFIG_STM32_DMACAPABLE=y
# CONFIG_STM32_EXTERNAL_RAM is not set
...
# CONFIG_STM32_PWM_LL_OPS is not set
# CONFIG_STM32_TIM8_PWM is not set
# CONFIG_STM32_TIM9_PWM is not set
# CONFIG_STM32_TIM10_PWM is not set
# CONFIG_STM32_TIM11_PWM is not set
# CONFIG_STM32_TIM8_ADC is not set
...
#
# end of STM32 TIMx Outputs Configuration
# end of Timer Configuration

#
# ADC Configuration
#
CONFIG_STM32_ADC1_RESOLUTION=0
CONFIG_STM32_ADC3_RESOLUTION=0
CONFIG_STM32_ADC_MAX_SAMPLES=16
# CONFIG_STM32_ADC_NO_STARTUP_CONV is not set
# CONFIG_STM32_ADC_NOIRQ is not set
# CONFIG_STM32_ADC_LL_OPS is not set
CONFIG_STM32_ADC1_DMA=y
CONFIG_STM32_ADC1_SCAN=y
CONFIG_STM32_ADC1_DMA_CFG=0
CONFIG_STM32_ADC1_ANIOC_TRIGGER=1
# CONFIG_STM32_ADC3_DMA is not set
# CONFIG_STM32_ADC3_SCAN is not set
CONFIG_STM32_ADC3_ANIOC_TRIGGER=1
CONFIG_STM32_ADC1_INJECTED_CHAN=0
CONFIG_STM32_ADC3_INJECTED_CHAN=0
# CONFIG_STM32_ADC1_EXTSEL is not set
# CONFIG_STM32_ADC3_EXTSEL is not set
# CONFIG_STM32_ADC1_JEXTSEL is not set
# CONFIG_STM32_ADC3_JEXTSEL is not set
...
# end of Serial Driver Configuration

#
# HCI UART Driver Configuration
#
# CONFIG_STM32_HCIUART_SW_RXFLOW is not set
# end of HCI UART Driver Configuration
# end of U[S]ART Configuration
...
# CONFIG_STM32_SPI4_DMA is not set
# CONFIG_STM32_SPI5_DMA is not set
...
# RTC Configuration
#
CONFIG_STM32_RTC_MAGIC_REG=0
CONFIG_STM32_RTC_MAGIC=0xfacefeed
CONFIG_STM32_RTC_MAGIC_TIME_SET=0xf00dface
CONFIG_STM32_RTC_LSECLOCK=y
# CONFIG_STM32_RTC_LSICLOCK is not set
# CONFIG_STM32_RTC_HSECLOCK is not set
# end of RTC Configuration

#
# USB Device Configuration
#
# CONFIG_STM32_FOC is not set
...
# CONFIG_ARCH_INSTRUMENT_ALL is not set
...
# CONFIG_ARCH_PERF_EVENTS is not set
...
# CONFIG_ARCH_DEADLOCKDUMP is not set
...
# Bring-Up Options
#
# CONFIG_SUPPRESS_CLOCK_CONFIG is not set
# CONFIG_SUPPRESS_INTERRUPTS is not set
# CONFIG_SUPPRESS_TIMER_INTS is not set
# CONFIG_SUPPRESS_SERIAL_INTS is not set
# CONFIG_SUPPRESS_UART_CONFIG is not set
# end of Bring-Up Options
...
# end of Boot Memory Configuration
# end of System Type

#
# Board Selection
#
# CONFIG_ARCH_BOARD_TC397 is not set
# CONFIG_ARCH_BOARD_STM32F427A_MINIMAL is not set
CONFIG_ARCH_BOARD_CUSTOM=y

#
# Custom Board Configuration
#
CONFIG_ARCH_BOARD_CUSTOM_NAME="cubus_em"
CONFIG_ARCH_BOARD_CUSTOM_DIR="../APN_BOARDS/cubus_em"
...
# STM32 Led drivers
#
CONFIG_STM32_OWN_LED=y
# end of STM32 Led drivers
...
# CONFIG_BOARD_USBDEV_PIDVID is not set
...
# CONFIG_DISABLE_IDLE_LOOP is not set
...
# CONFIG_CLOCK_ADJTIME is not set
...
# CONFIG_PTHREAD_MUTEX_DEFAULT_PRIO_INHERIT is not set
CONFIG_PTHREAD_CLEANUP_STACKSIZE=0
# CONFIG_CANCELLATION_POINTS is not set
# end of Pthread Options
...
# end of System Auto Instrumentation
...
# CONFIG_SIG_SIGPROF_ACTION is not set
...
# end of Stack and heap information

# CONFIG_SCHED_BACKTRACE is not set
# CONFIG_LIB_SYSCALL is not set
# end of RTOS Features
...
#
# IPCC driver requires CONFIG_EXPERIMENTAL
#
...
# CONFIG_DRIVERS_VIRTIO is not set
CONFIG_BCH=y
...
# end of IO Expander/GPIO Support
...
# CONFIG_MTD_CONFIG_NAMED is not set
# CONFIG_MTD_CONFIG_FAIL_SAFE is not set
...
CONFIG_FILEMTD=y
CONFIG_FILEMTD_BLOCKSIZE=256
CONFIG_FILEMTD_ERASESIZE=65536
CONFIG_FILEMTD_ERASESTATE=0xff
# CONFIG_MTD_LOOP is not set
# CONFIG_NULLMTD is not set
# CONFIG_MTD_AT24XX is not set
# CONFIG_MTD_AT25EE is not set
...
CONFIG_MTD_MT25QL=y
CONFIG_MT25QL_SPI_PIN_NUMBER=3
CONFIG_MT25QL_SPIMODE=0
CONFIG_MT25QL_SPIFREQUENCY=20000000
CONFIG_MT25QL_MANUFACTURER=0x20
CONFIG_MT25QL_MEMORY_TYPE=0xBA
CONFIG_MT25QL_SUBSECTOR_ERASE=y
CONFIG_MT25QL_4_BYTE_MODE=y
CONFIG_MT25QL_DEBUG=y
...
# end of Battery Management Support
...
# end of Power Supply Support

#
# Relay Support
#
# CONFIG_RELAY is not set
# end of Relay Support

# CONFIG_REGMAP is not set
# CONFIG_RMT is not set
# CONFIG_RPTUN is not set
CONFIG_SENSORS=y
CONFIG_USENSOR=y
# CONFIG_SENSORS_WTGAHRS2 is not set
# CONFIG_SENSORS_GOLDFISH_SENSOR is not set
# CONFIG_SENSORS_APDS9960 is not set
# CONFIG_SENSORS_APDS9922 is not set
# CONFIG_SENSORS_AK09912 is not set
# CONFIG_SENSORS_AS5048B is not set
# CONFIG_SENSORS_AS5048A is not set
# CONFIG_SENSORS_BH1749NUC is not set
# CONFIG_SENSORS_BH1750FVI is not set
# CONFIG_SENSORS_BMG160 is not set
# CONFIG_SENSORS_BMI160 is not set
# CONFIG_SENSORS_BMI270 is not set
# CONFIG_SENSORS_BMM150 is not set
# CONFIG_SENSORS_BMP180 is not set
# CONFIG_SENSORS_BMP280 is not set
# CONFIG_SENSORS_BME680 is not set
...
# CONFIG_SENSORS_MS56XX is not set
# CONFIG_SENSORS_MS58XX is not set
# CONFIG_SENSORS_MPL115A is not set
# CONFIG_SENSORS_ADXL345 is not set
# CONFIG_SENSORS_ADXL362 is not set
# CONFIG_SENSORS_ADXL372 is not set
CONFIG_SENSORS_MPU60X0=y
CONFIG_MPU60X0_SPI=y
# CONFIG_MPU60X0_I2C is not set
# CONFIG_MPU60X0_EXTI is not set
CONFIG_MPU60X0_EXT_SYNC_SET=0
CONFIG_MPU60X0_DLPF_CFG=1
CONFIG_MPU60X0_GYRO_FS_SEL=2
CONFIG_MPU60X0_ACCEL_AFS_SEL=2
# CONFIG_SENSORS_MPU9250 is not set
# CONFIG_SENSORS_MAX44009 is not set
# CONFIG_SENSORS_MAX31855 is not set
# CONFIG_SENSORS_MAX31865 is not set
# CONFIG_SENSORS_MAX6675 is not set
CONFIG_SENSORS_LIS3MDL=y
CONFIG_SENSORS_LIS3MDL_ORB=y
CONFIG_SENSORS_LIS3MDL_ORB_BUFFER_SIZE=1
CONFIG_SENSORS_LIS3MDL_THREAD_STACKSIZE=1024
CONFIG_SENSORS_LIS3MDL_POLL_INTERVAL=3000000
...
# CONFIG_SENSORS_LTR308 is not set
CONFIG_ARCH_HAVE_SERIAL_TERMIOS=y
CONFIG_SERIAL=y
CONFIG_SERIAL_CONSOLE=y
# CONFIG_SERIAL_GDBSTUB is not set
# CONFIG_UART_PL011 is not set
# CONFIG_CMSDK_UART is not set
...
# end of USART6 Configuration

# CONFIG_RAM_UART is not set
...
# SYSLOG channels
#
CONFIG_SYSLOG_DEVPATH="/dev/tty5"
# CONFIG_SYSLOG_CHAR is not set
# CONFIG_SYSLOG_STREAM is not set
CONFIG_SYSLOG_CONSOLE=y
CONFIG_SYSLOG_DEFAULT=y
# CONFIG_SYSLOG_RPMSG_SERVER_CHARDEV is not set
# CONFIG_SYSLOG_FILE is not set
# CONFIG_SYSLOG_CHARDEV is not set
# CONFIG_SYSLOG_IOCTL is not set
# end of System Logging
...
# CONFIG_MATH_FFT is not set
# CONFIG_MATH_MPI is not set
# end of MATH Acceleration Support

#
# Segger RTT drivers
#
# CONFIG_STREAM_RTT is not set
# CONFIG_SYSLOG_RTT is not set
# CONFIG_SERIAL_RTT0 is not set
# CONFIG_SERIAL_RTT1 is not set
# CONFIG_SERIAL_RTT2 is not set
# end of Segger RTT drivers

# CONFIG_DMA is not set
# CONFIG_DEVICE_TREE is not set
...
CONFIG_FS_ROMFS=y
# CONFIG_FS_ROMFS_CACHE_NODE is not set
...
# end of Font Cache Pixel Depths
...
# CONFIG_MM_TLSF_MANAGER is not set
...
# end of Common I/O Buffer Support
...
# end of Program Execution Options

CONFIG_LIBC_HOSTNAME=""
CONFIG_LIBC_OPEN_MAX=255
...
# end of signal Decode Support

#
# pthread support
#
# CONFIG_PTHREAD_ATFORK is not set
# end of pthread support

# CONFIG_LIBC_DLFCN is not set
# CONFIG_LIB_GDBSTUB is not set
...
# end of Locale Support

CONFIG_LIBC_LZF=y
CONFIG_LIBC_LZF_SMALL=y
# CONFIG_LIBC_LZF_FAST is not set
# CONFIG_LIBC_LZF_FASTEST is not set
...
# end of Thread Local Storage (TLS)
...
# end of Network-Related Options
...
# CONFIG_FDSAN is not set
CONFIG_LIBC_FTOK_VFS_PATH="/var/ftok"
# CONFIG_LIBC_UNAME_DISABLE_TIMESTAMP is not set
...
# CONFIG_LIBC_FDT is not set
# CONFIG_LIBM is not set
# CONFIG_LIBM_NEWLIB is not set
# CONFIG_LIBM_OPENLIBM is not set
CONFIG_LIBM_TOOLCHAIN=y
# CONFIG_LIBM_NONE is not set
...
#
# end of Open Asymmetric Multi Processing
...
#
# CONFIG_AUDIOUTILS_FMSYNTH_LIB is not set
# CONFIG_AUDIOUTILS_MMLPARSER_LIB is not set
# CONFIG_AUDIOUTILS_NXAUDIO_LIB is not set
# end of Audio Utility libraries

#
# Benchmark Applications
#
# CONFIG_BENCHMARK_COREMARK_PRO is not set
# CONFIG_BENCHMARK_COREMARK is not set
# CONFIG_BENCHMARK_DHRYSTONE is not set
# CONFIG_BENCHMARK_IOZONE is not set
# CONFIG_BENCHMARK_OSPERF is not set
# CONFIG_BENCHMARK_RAMSPEED is not set
# CONFIG_BENCHMARK_SPINLOCK is not set
# CONFIG_BENCHMARK_SUPERPI is not set
# end of Benchmark Applications

#
# Bootloader Utilities
#
# CONFIG_BOOT_MCUBOOT is not set
# CONFIG_BOOT_MINIBOOT is not set
# end of Bootloader Utilities

#
# CAN Utilities
#
# CONFIG_CANUTILS_LELYCANOPEN is not set
# end of CAN Utilities
...
#
# Crypto: TinyCrypt cryptography library
#
# CONFIG_TINYCRYPT is not set
# end of Crypto: TinyCrypt cryptography library
# end of Cryptography Library Support

#
# Custom_Apps
#
# CONFIG_CUSTOM_APPS_INT_ADC is not set
CONFIG_CUSTOM_APPS_ADS7953=y
CONFIG_CUSTOM_APPS_ADS7953_PROGNAME="ads7953"
CONFIG_CUSTOM_APPS_ADS7953_PRIORITY=100
CONFIG_CUSTOM_APPS_ADS7953_STACKSIZE=2048
CONFIG_IOCTL_MODE=y
CONFIG_EXT_ADC_NO=1
CONFIG_EADC0_PATH="/dev/ext_adc0"
CONFIG_EADC0_CHAN_NO=12
# CONFIG_CUSTOM_APPS_COM_APP is not set
CONFIG_CUSTOM_APPS_CUBUS_APP=y
CONFIG_CUSTOM_APPS_CUBUS_APP_PROGNAME="Cubus"
CONFIG_CUSTOM_APPS_CUBUS_APP_SAMPLE_RATE=100
CONFIG_CUSTOM_APPS_CUBUS_USE_EXT_ADC=y
CONFIG_CUSTOM_APPS_CUBUS_USE_INT_ADC1=y
CONFIG_CUSTOM_APPS_CUBUS_INT_ADC1_DEVPATH="/dev/adc0"
CONFIG_CUSTOM_APPS_CUBUS_INT_ADC1_NSAMPLES=1
CONFIG_CUSTOM_APPS_CUBUS_INT_ADC1_GROUPSIZE=16
CONFIG_CUSTOM_APPS_CUBUS_INT_ADC1_SWTRIG=y
CONFIG_CUSTOM_APPS_CUBUS_USE_INT_ADC3=y
CONFIG_CUSTOM_APPS_CUBUS_INT_ADC3_DEVPATH="/dev/adc2"
CONFIG_CUSTOM_APPS_CUBUS_INT_ADC3_NSAMPLES=1
CONFIG_CUSTOM_APPS_CUBUS_INT_ADC3_GROUPSIZE=1
CONFIG_CUSTOM_APPS_CUBUS_INT_ADC3_SWTRIG=y
CONFIG_CUSTOM_APPS_CUBUS_APP_PRIORITY=100
CONFIG_CUSTOM_APPS_CUBUS_APP_STACKSIZE=42048
# CONFIG_CUSTOM_APPS_CUSTOM_HELLO is not set
# CONFIG_CUSTOM_APPS_DOWNLOADER is not set
# CONFIG_CUSTOM_APPS_GPIO_CONTROL is not set
CONFIG_CUSTOM_APPS_MAG_MAIN=y
CONFIG_CUSTOM_APPS_MAG_MAIN_PROGNAME="magmain"
CONFIG_CUSTOM_APPS_MAG_MAIN_PRIORITY=100
CONFIG_CUSTOM_APPS_MAG_MAIN_STACKSIZE=2048
CONFIG_CONFIG_MPU_PATH="/dev/mpu6500"
# CONFIG_CUSTOM_APPS_MPU6500 is not set
CONFIG_CUSTOM_APPS_SPI_ADC_TEST=y
CONFIG_CUSTOM_APPS_SPI_ADC_TEST_PROGNAME="spi_adc_test"
CONFIG_CUSTOM_APPS_SPI_ADC_TEST_PRIORITY=100
CONFIG_CUSTOM_APPS_SPI_ADC_TEST_STACKSIZE=2048
# CONFIG_CUSTOM_APPS_SPI_DRIVER_TEST is not set
CONFIG_CUSTOM_APPS_STORAGE_MANAGER=y
CONFIG_CUSTOM_APPS_STORAGE_MANAGER_PROGNAME="storage_manager"
CONFIG_CUSTOM_APPS_STORAGE_MANAGER_PRIORITY=100
CONFIG_CUSTOM_APPS_STORAGE_MANAGER_STACKSIZE=2048
# end of Custom_Apps
...
CONFIG_EXAMPLES_ADC_DEVPATH="/dev/adc2"
...
# CONFIG_EXAMPLES_FMSYNTH is not set
...
# CONFIG_EXAMPLES_HELLO_NIM is not set
# CONFIG_EXAMPLES_HELLO_RUST is not set
# CONFIG_EXAMPLES_HELLO_WASM is not set
# CONFIG_EXAMPLES_HELLO_ZIG is not set
# CONFIG_EXAMPLES_HELLOXX is not set
# CONFIG_EXAMPLES_HIDKBD is not set
# CONFIG_EXAMPLES_HX711 is not set
# CONFIG_EXAMPLES_IGMP is not set
# CONFIG_EXAMPLES_INA219 is not set
# CONFIG_EXAMPLES_INA226 is not set
# CONFIG_EXAMPLES_ISL29023 is not set
# CONFIG_EXAMPLES_KEYBOARD is not set
# CONFIG_EXAMPLES_LIBTEST is not set
# CONFIG_EXAMPLES_LP503X is not set
# CONFIG_EXAMPLES_LSM330SPI_TEST is not set
# CONFIG_EXAMPLES_LUA_MODULE is not set
# CONFIG_EXAMPLES_MAX31855 is not set

#
# MCUboot Examples
#
# CONFIG_EXAMPLES_MCUBOOT_SLOT_CONFIRM is not set
# CONFIG_EXAMPLES_MCUBOOT_SWAP_TEST is not set
# end of MCUboot Examples

# CONFIG_EXAMPLES_MEDIA is not set
# CONFIG_EXAMPLES_MLX90614 is not set
# CONFIG_EXAMPLES_MMLPARSER is not set
# CONFIG_EXAMPLES_MODBUS is not set
# CONFIG_EXAMPLES_MODBUSMASTER is not set
# CONFIG_EXAMPLES_MOUNT is not set
# CONFIG_EXAMPLES_MTDPART is not set
# CONFIG_EXAMPLES_NIMBLE is not set
# CONFIG_EXAMPLES_NNG_TEST is not set
...
# CONFIG_EXAMPLES_SENSOR_FUSION is not set
# CONFIG_EXAMPLES_SERIALBLASTER is not set
# CONFIG_EXAMPLES_SERIALRX is not set
# CONFIG_EXAMPLES_SERLOOP is not set
# CONFIG_EXAMPLES_SETTINGS is not set
# CONFIG_EXAMPLES_SLCD is not set
# CONFIG_EXAMPLES_SMPS is not set
# CONFIG_EXAMPLES_STAT is not set
# CONFIG_EXAMPLES_STEPPER is not set
# CONFIG_EXAMPLES_TCP_IPC_CLIENT is not set
# CONFIG_EXAMPLES_TCP_IPC_SERVER is not set
...
# CONFIG_EXAMPLES_WIEGAND is not set
# CONFIG_EXAMPLES_WS2812 is not set
...
# Games
#
# CONFIG_GAMES_BRICKMATCH is not set
# end of Games
...
# CONFIG_SCPI_PARSER is not set
# end of Industrial Applications

#
# Inertial Libraries Support
#
# end of Inertial Libraries Support
...
# CONFIG_INTERPRETERS_TOYWASM is not set
...
# Logging Utilities
#
# CONFIG_LOGGING_EMBEDLOG is not set
# CONFIG_LOGGING_NXSCOPE is not set
# end of Logging Utilities

#
# LTE Libraries and NSH Add-Ons
#
# CONFIG_LTE_LAPI is not set
# end of LTE Libraries and NSH Add-Ons

#
# Math Library Support
#
# CONFIG_MATH_LIBTOMMATH is not set
# end of Math Library Support

#
# Machine Learning Support
#
# CONFIG_CMSIS is not set
# CONFIG_DARKNET_YOLO is not set
# CONFIG_NNABLA_RT is not set
# end of Machine Learning Support
...
# CONFIG_MATTER is not set
# CONFIG_NETUTILS_ESP8266 is not set
# CONFIG_NETUTILS_FTPC is not set
# CONFIG_NETUTILS_IPTABLES is not set
# CONFIG_NETUTILS_JSONCPP is not set
# CONFIG_NETUTILS_LIBCOAP is not set
# CONFIG_NETUTILS_MQTTC is not set
# CONFIG_NETUTILS_NANOPB is not set
# CONFIG_NETUTILS_NNG is not set
# CONFIG_NETUTILS_REXEC is not set
# CONFIG_NETUTILS_REXECD is not set
# CONFIG_NETUTILS_RTPTOOLS is not set
...
# end of Disable Individual commands
...
# end of Configure Command Options
...
# CONFIG_SYSTEM_SETTINGS is not set
...
CONFIG_UORB_TESTS=y
CONFIG_UORB_SRORAGE_DIR="/data/"
# CONFIG_DEBUG_UORB is not set
# CONFIG_SYSTEM_VI is not set
# CONFIG_SYSTEM_YMODEM is not set
# CONFIG_LIB_ZLIB is not set
# CONFIG_SYSTEM_ZMODEM is not set
# end of System Libraries and NSH Add-Ons

#
# Testing
#
# CONFIG_TESTING_ARCH_LIBC is not set
# CONFIG_TESTING_ATOMIC is not set
# CONFIG_TESTING_BATTERYDUMP is not set
# CONFIG_TESTING_CPULOAD is not set
# CONFIG_TESTING_CRYPTO is not set
# CONFIG_TESTING_CXXTEST is not set
# CONFIG_TESTING_FATUTF8 is not set
# CONFIG_TESTING_FMEMOPEN_TEST is not set
# CONFIG_TESTING_FOPENCOOKIE_TEST is not set
...
CONFIG_TESTING_LTP_STACKSIZE=4096
# CONFIG_TESTING_MEMORY_STRESS is not set
# CONFIG_UTILS_MEMTESTER is not set
# CONFIG_TESTING_MM is not set
# CONFIG_TESTING_MONKEY is not set
# CONFIG_TESTING_NAND_SIM is not set
# CONFIG_TESTING_NIST_STS is not set
# CONFIG_TESTING_NXFFS is not set
# CONFIG_TESTING_OPEN_MEMSTREAM is not set
# CONFIG_TESTING_OSTEST is not set
# CONFIG_TESTING_RAMTEST is not set
...
# CONFIG_TESTING_UCLIBCXXTEST is not set
...
# Wasm Build Options
#
# CONFIG_TOOLS_WASM_BUILD is not set
# end of Wasm Build Options
# end of Extra Tools
...
# end of IEEE 802.15.4 applications
# end of Wireless Libraries and NSH Add-Ons
