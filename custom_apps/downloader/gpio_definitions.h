...
#define GPIO_3V3_COM_EN			    (GPIO_OUTPUT|GPIO_SPEED_2MHz|GPIO_PORTH|GPIO_PIN11)
...
#define GPIO_MSN_3V3_EN			    (GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTH|GPIO_PIN5)//h3//h5
#define GPIO_MSN_3V3_EN_EM			    (GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTH|GPIO_PIN3)//h3//h5
...
#define GPIO_MUX_EN_EM		        (GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_SET|GPIO_PORTI|GPIO_PIN0)
