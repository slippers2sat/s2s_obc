...
#ifndef __APPS_CUSTOM_APPS_GPIO_CONTROL_H
#define __APPS_CUSTOM_APPS_GPIO_CONTROL_H
...
#define GPIO_COM_4V_EN			    (GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTA|GPIO_PIN1)//H12
...
#define GPIO_MUX_EN		           	(GPIO_OUTPUT|GPIO_FLOAT|GPIO_SPEED_2MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTG|GPIO_PIN6)//i6
